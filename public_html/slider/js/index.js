...
var slides = [{
  city: 'Физика',
  country: 'То, что будет любить сильнее девушки',
  img: 'https://img2.goodfon.ru/original/1920x1080/e/87/sheldon-sheldon-fizika.jpg'
}, {
  city: 'Математика',
  country: 'То, что будет любить сильнее матери',
  img: 'https://img.wallpapersafari.com/desktop/1920/1080/97/43/h094Pr.jpg'
}, {
  city: 'Инж.Графика',
  country: 'То что будет любить сильнее бабушки',
  img: 'http://fullhdwallpapers.ru/image/3d/14666/chertezh.jpg'
}, {
  city: 'Информатика',
  country: 'То, что будет тебя любить',
  img: 'https://ph0.qna.center/storage/photos/psihologgalina/1687375.jpg'}];
// }, {
//   city: 'Moscow',
//   country: 'Russia',
